...
export function LogViewer({ content }: { content?: string }) {
  ...
  return (
    <div className="overflow-hidden rounded border border-[#333] bg-[#0a0a0a] shadow-panel">
      ...
      <pre className="max-h-[32rem] overflow-auto bg-[#0a0a0a] p-4 font-mono text-[13px] leading-6 text-slate-300">{content}</pre>
    </div>
  );
}
